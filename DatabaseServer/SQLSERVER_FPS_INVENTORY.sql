IF NOT EXISTS(SELECT * FROM sys.databases WHERE name = 'FPS_Inventory')
BEGIN
...
INSERT INTO fps_users (name)
VALUES ('Sam Rodriguez')
GO
...
CREATE TRIGGER updateQuantitiesOnInsertTrigger ON checkouts AFTER INSERT AS
BEGIN
...
CREATE TRIGGER updateQuantitiesOnUpdateTrigger ON checkouts AFTER UPDATE AS 
BEGIN
	UPDATE fps_inventory.inventory 
